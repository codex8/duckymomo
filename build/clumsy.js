...
var newclumsy=Math.floor(Math.random() * 5) + 1
var newpipe=Math.floor(Math.random() * 5) + 1
var newbg=Math.floor(Math.random() * 6) + 1
...
game.resources = [
    // images
    {name: "bg", type:"image", src: "data/img/bg"+newbg+".png"},
    {name: "clumsy", type:"image", src: "data/img/clumsy"+newclumsy+".png"},
    {name: "pipe", type:"image", src: "data/img/pipe"+newpipe+".png"},
...
var PipeEntity = me.ObjectEntity.extend({
    init: function(x, y) {
        ...
        this.parent(x, y, settings);
        this.alwaysUpdate = true;
        this.gravity = 5; //Controll forwarding speed
...
game.HUD.ScoreItem = me.Renderable.extend({
    ...
    init: function(x, y) {
        ...
        this.stepsFont = new me.Font('gamefont', 80, 'yellow', 'center');
    ...
    onResetEvent: function() {
        ...
        me.game.world.addChild(new (me.Renderable.extend ({
            ...
            init: function() {
                    ...
                    this.font = new me.Font('gamefont', 20, '#cf1b1b');
            },
            update: function () {
                    return true;
            },
